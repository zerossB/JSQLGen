...
public class AttributeTimeGen extends AttributeGen{
    ...
    public String genObj2Form(){
        String code = "";
        code += "        t"+att.getNameU()+".setText("+classBean.getNameL()+".get"+att.getNameU()+"F(\"HH:mm:ss\"));\n";
        return code;
    }
    @Override
    public String genForm2Obj(){
        String code = "";
        code += "        "+classBean.getNameL()+".set"+att.getNameU()+"F(\"HH:mm:ss\",t"+att.getNameU()+".getText());\n";
        return code;
    }
    @Override
    ...
    public String genRefreshTab(){
        String code = "";
        code += "            line.add("+classBean.getNameL()+".get"+att.getNameU()+"F(\"HH:mm:ss\"));\n";
        return code;
    }
    @Override
