...
public class AttributeIntegerGen extends AttributeGen{
    ...
    public String genValidate(){
        String code = "";
        code += "        if(Integer.parseInt(t"+att.getNameU()+".getText())<0) fieldError +=\""+att.getNameU()+"\\n\";\n";
        return code;
    }
    @Override
    ...
    public String genInitComponentPData(){
        ...
        code += "        t"+att.getNameU()+".setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat(\"#0\"))));\n";
    ...
    public String genXMLpData(){
        ...
        code += "              <Format format=\"#0\" subtype=\"-1\" type=\"0\"/>\n";
        code += "            </Property>\n";
