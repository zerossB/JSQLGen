...
public class ClassTabGen {
     ...
     * @param classBean 
     */
    public ClassTabGen(project.Project proj, project.ClassBean classBean){
        this.proj = proj;
    ...
    public String getJavaCode(){
        ...
        code += "        initComponents();\n";
        code += "        list = new java.util.ArrayList<"+classBean.getName()+">();\n";
        code += "        refresh();\n";
        ...
        code += "        list.addAll("+classBean.getName()+"DAO.loadList(connection));\n";
