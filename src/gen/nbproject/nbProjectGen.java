 ...
 * @author marcos
 */
public final class nbProjectGen {
    private project.Project project;
    
    public nbProjectGen(project.Project project, String projectPath) throws java.io.IOException{
        ...
        if(!dir.exists() && project.getName().length()>0){
            ...
            dir.mkdir();
            copy("gen/lib/derby.jar", projectPath+"/lib/derby.jar");
            copy("gen/lib/derbyclient.jar", projectPath+"/lib/derbyclient.jar");
            copy("gen/lib/derbyLocale_pt_BR.jar", projectPath+"/lib/derbyLocale_pt_BR.jar");
            ...
            dir.mkdir();
            code = new gen.dbaccess.ClassDBAccessGen(project).getJavaCode();
            ...
            for (int i=1;i<=maxLevel;i++){
                for (project.ClassBean classBean : project.getClassBeans()){
                    if(classBean.getLevel(project)==i){
                        ...
                        //DAO
                        code = new gen.dao.ClassDAOGen(project, classBean).getJavaCode();
    ...
    public String get_nbproject_project_properties(){
        ...
        code += "excludes=\n";
        code += "file.reference.derby.jar=lib/derby.jar\n";
        code += "file.reference.derbyclient.jar=lib/derbyclient.jar\n";
        code += "file.reference.derbyLocale_pt_BR.jar=lib/derbyLocale_pt_BR.jar\n";
        code += "includes=**\n";
        code += "jar.compress=false\n";
        code += "javac.classpath=\\\n";
        code += "    ${file.reference.derby.jar}:\\\n";
        code += "    ${file.reference.derbyclient.jar}:\\\n";
        code += "    ${file.reference.derbyLocale_pt_BR.jar}\n";
